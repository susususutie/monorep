...
export function createMiniStore<StateType = any, ActionType extends string = string>(
    reducer: Reducer<StateType, ActionType>
) {
    let $state: StateType = reducer(undefined, { type: "@@INIT@@" as ActionType });
...
export const demoStore = createMiniStore<
    number,
